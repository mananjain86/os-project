...
00000000000005b0 <thread_create>:
...
malloc(uint nbytes)
{
 ...
 a5c:	004a1a1b          	slliw	s4,s4,0x4
    ...
    if(p == freep)
 a60:	00001917          	auipc	s2,0x1
 a64:	5a090913          	addi	s2,s2,1440 # 2000 <freep>
  if(p == SBRK_ERROR)
 a68:	5afd                	li	s5,-1
 ...
 a78:	5ac78793          	addi	a5,a5,1452 # 2020 <base>
 ...
 aee:	50a73b23          	sd	a0,1302(a4) # 2000 <freep>
      return (void*)(p + 1);
