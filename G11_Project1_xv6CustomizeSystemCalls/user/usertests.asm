...
0000000000004e24 <thread_create>:
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5210:	00004797          	auipc	a5,0x4
    5214:	2807b783          	ld	a5,640(a5) # 9490 <freep>
    ...
    523c:	00e6ea63          	bltu	a3,a4,5250 <free+0x4a>
{
  ...
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp;
  freep = p;
    527a:	00004717          	auipc	a4,0x4
    527e:	20f73b23          	sd	a5,534(a4) # 9490 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    52a8:	1ec53503          	ld	a0,492(a0) # 9490 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    if(p == freep)
    52d4:	00004917          	auipc	s2,0x4
    52d8:	1bc90913          	addi	s2,s2,444 # 9490 <freep>
  if(p == SBRK_ERROR)
    52dc:	5afd                	li	s5,-1
    ...
    base.s.ptr = freep = prevp = &base;
    52e8:	0000b797          	auipc	a5,0xb
    52ec:	9d078793          	addi	a5,a5,-1584 # fcb8 <base>
    52f0:	00004717          	auipc	a4,0x4
    52f4:	1af73023          	sd	a5,416(a4) # 9490 <freep>
  ...
  if(p == SBRK_ERROR)
    ...
    535a:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    535e:	00004717          	auipc	a4,0x4
    5362:	12a73923          	sd	a0,306(a4) # 9490 <freep>
      return (void*)(p + 1);
